...
static const struct ATCommand_s ATCommand[] =
{
  ...
  /* USER CODE BEGIN ATCommand */
	{
    .string = AT_GPIOTEST,
    .size_string = sizeof(AT_GPIOTEST) - 1,
#ifndef NO_HELP
    .help_string = "AT"AT_GPIOTEST" GPIO test\r\n",
#endif /* !NO_HELP */
    .get = AT_return_error,
    .set = AT_GPIO_TEST,
    .run = AT_return_error,
	...
	{
    .string = AT_CHIPID,
    .size_string = sizeof(AT_CHIPID) - 1,
#ifndef NO_HELP
    .help_string = "AT"AT_CHIPID" Get ChipId\r\n",
#endif /* !NO_HELP */
    .get = AT_CHIPID_GET,
    .set = AT_return_error,
    .run = AT_return_error,
	...
	{
    .string = AT_PINGPONG,
    .size_string = sizeof(AT_PINGPONG) - 1,
#ifndef NO_HELP
    .help_string = "AT"AT_PINGPONG" PINGPONG RF test\r\n",
#endif /* !NO_HELP */
    .get = AT_return_error,
    .set = AT_PINGPONG_TEST,
    .run = AT_return_error,
  },
	{
		.string = AT_MASK,
		.size_string = sizeof(AT_MASK) - 1,
	#ifndef NO_HELP
		.help_string = "AT"AT_MASK" Set the frequency group mask for lorawan to work with\r\n",
	#endif /* !NO_HELP */
		.get = AT_return_error,
		.set = AT_BANDMASK_SET,
		.run = AT_return_error,
	...
	{
    .string = AT_MODE,
    .size_string = sizeof(AT_MODE) - 1,
#ifndef NO_HELP
    .help_string = "AT"AT_MODE" Factory RF test\r\n",
#endif /* !NO_HELP */
    .get = AT_return_error,
    .set = AT_MODE_SET,
    .run = AT_return_error,
